...
public class ProxySourceGenerator : IIncrementalGenerator
{
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        ...
        // 6. Combine with CompilationProvider and register source output
    ...
    {
        var types = source.Metadata.Item1.Item1.Types;
        var activityMethods = source.Metadata.Item1.Item1.ActivityMethods;
        var activityNameItems = source.Metadata.Item1.ActivityNameItems;
        var nonActivityMethods = source.Metadata.NonActivityMethods;

        Execute(spc, source.Compilation, types, activityMethods, activityNameItems, nonActivityMethods);
    }
        ...
        ImmutableArray<MethodExtractionResult> nonActivityMethodResults)
    {
        ...
        InterceptorEmitter.Emit(context, callSites, allTypes.ToImmutable());
    }
